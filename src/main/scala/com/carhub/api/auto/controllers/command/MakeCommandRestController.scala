...
class MakeCommandRestController(@Autowired val makeCommandService: MakeCommandService) {
  ...
  @ResponseBody
  @PutMapping(value = Array("/makes/{id}"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/makes/{id}"), params = Array("description"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/makes/{id}"), params = Array("foundation"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/makes/{id}"), params = Array("founder"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/makes/{id}"), params = Array("headquarter"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/makes/{id}"), params = Array("closed"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/makes/{id}/logo"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/makes/{id}"), params = Array("name"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/makes/{id}"), params = Array("oldName"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/makes/{id}"))
