...
class EngineCommandRestController(@Autowired val engineCommandService : EngineCommandService) {
  ...
  @ResponseBody
  @PostMapping(value = Array("/engines"))
  ...
  @ResponseBody
  @PutMapping(value = Array("/engines/{id}"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/engines/{id}"), params = Array("compression"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/engines/{id}"), params = Array("coolant"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/engines/{id}"), params = Array("bore"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/engines/{id}"), params = Array("displacement"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/engines/{id}"), params = Array("power"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/engines/{id}"), params = Array("fuel"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/engines/{id}"), params = Array("injection"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/engines/{id}"), params = Array("name"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/engines/{id}"), params = Array("cylinders"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/engines/{id}"), params = Array("oil"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/engines/{id}"), params = Array("piston"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/engines/{id}"), params = Array("position"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/engines/{id}"), params = Array("torque"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/engines/{id}"), params = Array("valves"))
  ...
  @PreAuthorize("#oauth2.hasScope('UPDATE_PRIVILEGE')")
  @ResponseBody
  @PatchMapping(value = Array("/engines/{id}"), params = Array("turbine"))
  ...
  @ResponseBody
  @DeleteMapping(Array("/engines/{id}"))
